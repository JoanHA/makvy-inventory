  ...
  return (
    ...
    <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
        <div className="flex flex-wrap justify-between  mx-auto max-w-screen-xl">
            <a href="#" className="flex items-center justify-center  flex-1 self-center" >
                {/* <img src="https://flowbite.com/docs/images/logo.svg" className="mr-3 h-6 sm:h-9" alt="Flowbite Logo" /> */}
                <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Makvy Store</span>
            </a>
            <div className="flex items-between lg:order-2">
            ...
            <div className="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1 self-end justify-self-end" id="mobile-menu-2">
